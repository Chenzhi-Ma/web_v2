...
with st.container():
    ...
    st.write("---")
    building_typology = ['Office-high', 'Office-mid', 'Apartment-high', 'Apartment-mid', 'Hospital-high',
                         'Hospital-mid', 'Hotel-high', 'Hotel-mid']
    st.markdown(f'**Building typology: {building_typology[BT - 1]}**')
